...
# REGEX = re.compile(r'^\s*[0-9]*:\s*Rowwise\s*Max\[\s*([0-9]*\s*)\]=\s*([0-9]*.[0-9]*)\s*Min\[\s*([0-9]*\s*)\]=\s*([0-9]*.[0-9]*)\s*Avg=\s*([0-9]*.[0-9]*)$')
REGEX = re.compile(r'^\s*Columnwise\s*Max\[\s*([0-9]*\s*)\]=\s*([0-9]*.[0-9]*)\s*Min\[\s*([0-9]*\s*)\]=\s*([0-9]*.[0-9]*)\s*Avg=\s*([0-9]*.[0-9]*)$')
